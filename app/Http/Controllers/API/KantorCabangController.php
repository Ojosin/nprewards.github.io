...
class KantorCabangController extends Controller
{
    ...
    {
        //
        $result =  \App\Models\M_kantor_cabang::
    ...
    public function store(Request $request)
    {
        ...
        $save = \App\Models\M_kantor_cabang::create($data);    
    ...
    {
        //
        return \App\Models\M_kantor_cabang::where('id_cabang', $id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $update = \App\Models\M_kantor_cabang::find($id);
    ...
    public function destroy($id)
    {
        ...
        \App\Models\M_kantor_cabang::find($id)->delete();
