                                        ...
                                        <div class="position-relative form-group">
                                            <label for="exampleEmail11" class="ml-1 bintang"> Kota / Kabupaten </label>
                                             <select class="form-control" id="kabupaten" name="kabupaten"  v-model="kantor_cabang.kode_kabupaten">
                                                ...
                                                <option  v-for="(item, index) in kabupaten " :key="index" :value="item.kode_kabupaten"> {{item.nama_kabupaten}} </option>
                                            </select>
                                            <!-- <input name='kode_kabupaten' id="kode_kabupaten" type="text"  v-model="kantor_cabang.kode_kabupaten"  :class="{'is-invalid':errors.kode_kabupaten}" class="form-control ml-1" > -->
...
export default {
    ...
    methods:{
        ...
        update_data(e){
            ...
            var app = this;
            app.InActive = true;
            $axios.put('/kantor_cabang/'+app.kantor_cabang.id_cabang,app.kantor_cabang).then(function(resp){
        ...
        edit_kantor_cabang(){
            ...
            $axios.get('kantor_cabang/'+id+'/edit')
            .then(function(resp){
                app.kantor_cabang.id_cabang=resp.data.id_cabang;
                app.kantor_cabang.jenis_kantor=resp.data.jenis_kantor;
                app.kantor_cabang.alamat =resp.data.alamat;
                app.kantor_cabang.kode_provinsi=resp.data.kode_provinsi;
                app.kantor_cabang.kode_kabupaten=resp.data.kode_kabupaten;
                app.kantor_cabang.kode_pos=resp.data.kode_pos;
                app.kantor_cabang.telepon=resp.data.telepon;
                app.kantor_cabang.fax=resp.data.fax;
                app.kantor_cabang.kapasitas=resp.data.kapasitas;
                app.kantor_cabang.luas=resp.data.luas;
