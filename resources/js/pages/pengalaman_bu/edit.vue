        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Edit Pengalaman Badan Usaha
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <!-- <input name='kode_sb' id="kode_sb" type="text"  ref="kode_sb"  v-model="pengalaman_bu.kode_sb" :class="{'is-invalid':errors.kode_sb}" class="form-control ml-1"> -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name='nilai_kontrak' id="nilai_kontrak" type="text" v-model="pengalaman_bu.nilai_kontrak"  @change="get_bobot()"   :class="{'is-invalid':errors.nilai_kontrak}" class="form-control ml-1">
...
export default {
    ...
    methods:{
        ...
        update_data(e){
            ...
            var app = this;
            app.InActive = true;
            $axios.put('/pengalaman_bu/'+app.pengalaman_bu.id_pengalaman_bu,app.pengalaman_bu).then(function(resp){
        ...
        edit_pengalaman_bu(){
            ...
            $axios.get('pengalaman_bu/'+id+'/edit')
            .then(function(resp){
                app.pengalaman_bu.id_pengalaman_bu=resp.data.id_pengalaman_bu;
                app.pengalaman_bu.kode_sb=resp.data.kode_sb;
                app.pengalaman_bu.nama_paket=resp.data.nama_paket;
                app.pengalaman_bu.pemberi_tugas=resp.data.pemberi_tugas;
                app.pengalaman_bu.deskripsi=resp.data.deskripsi;
                app.pengalaman_bu.tgl_kontrak=resp.data.tgl_kontrak;
                app.pengalaman_bu.tgl_mulai=resp.data.tgl_mulai;
                app.pengalaman_bu.tgl_selesai=resp.data.tgl_selesai;
                app.pengalaman_bu.nomor_kontrak=resp.data.nomor_kontrak;
                app.pengalaman_bu.utama=resp.data.utama;
                app.pengalaman_bu.nilai_kontrak=resp.data.nilai_kontrak;
                app.pengalaman_bu.bobot=resp.data.bobot;
                app.pengalaman_bu.nilai_kontrak_dibobotkan=resp.data.nilai_kontrak_dibobotkan;
                app.pengalaman_bu.no_berita_acara=resp.data.no_berita_acara;
                app.pengalaman_bu.tgl_berita_acara=resp.data.tgl_berita_acara;
                app.pengalaman_bu.lokasi_proyek=resp.data.lokasi_proyek;
                app.pengalaman_bu.jumlah_month=resp.data.jumlah_month;           
                app.pengalaman_bu.tahun=resp.data.tahun;           
            })
            .catch(function(resp){
