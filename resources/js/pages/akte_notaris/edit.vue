                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label for="exampleEmail11" class="ml-1 bintang"> TGL </label>
                                        <input name='tgl_pendirian_negara' id="tgl_pendirian_negara" v-model="akte_notaris.tgl_pendirian_negara"   type="date"  :class="{'is-invalid':errors.tgl_pendirian_negara}" class="form-control ml-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label for="exampleEmail11" class="ml-1 bintang"> Nama Notaris  <span style="color:red">*</span></label>
                                        <input name='nama_notaris_perubahan' id="nama_notaris_perubahan" type="text"  v-model="akte_notaris.nama_notaris_perubahan"  :class="{'is-invalid':errors.nama_notaris_perubahan}" class="form-control ml-1" >
                                        <div  v-if="errors.nama_notaris_perubahan"> <div style="color:red">{{errors.nama_notaris[0]}} </div>    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label for="examplePassword11" class="ml-1 bintang"> Alamat Notaris <span style="color:red">*</span></label>
                                        <input name='alamat_notaris_perubahan' id="alamat_notaris_perubahan" type="text" class="form-control ml-1"  v-model="akte_notaris.alamat_notaris_perubahan" :class="{'is-invalid':errors.tahap}">
                                        <div  v-if="errors.alamat_notaris_perubahan"> <div style="color:red">{{errors.alamat_notaris_perubahan[0]}} </div>    </div>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods:{
        ...
        clear_form(){
            this.akte_notaris.id_akte_notaris='';
        ...
        update_data(e){
            ...
            var app = this;
            app.InActive = true;
            $axios.put('/akte_notaris/'+app.akte_notaris.id_akte_notaris,app.akte_notaris).then(function(resp){
        ...
        edit_akte_notaris(){
            ...
            $axios.get('akte_notaris/'+id+'/edit')
            .then(function(resp){
                app.akte_notaris.tgl_pendirian=resp.data.tgl_pendirian;
                 app.akte_notaris.no_pendirian=resp.data.no_pendirian;
                 app.akte_notaris.notaris_pendirian=resp.data.notaris_pendirian;
                 app.akte_notaris.alamat_pendirian=resp.data.alamat_pendirian;
                 app.akte_notaris.provinsi_pendirian=resp.data.provinsi_pendirian;
                 app.akte_notaris.kota_pendirian=resp.data.kota_pendirian;
                 app.akte_notaris.tgl_menkum_pendirian=resp.data.tgl_menkum_pendirian;
                 app.akte_notaris.no_menkum_pendirian=resp.data.no_menkum_pendirian;
                 app.akte_notaris.tgl_pendirian_pengadilan=resp.data.tgl_pendirian_pengadilan;
                 app.akte_notaris.no_pendirian_pengadilan=resp.data.no_pendirian_pengadilan;
                 app.akte_notaris.tgl_pendirian_negara=resp.data.tgl_pendirian_negara;
                 app.akte_notaris.no_pendirian_negara=resp.data.no_pendirian_negara;
                 app.akte_notaris.tgl_perubahan=resp.data.tgl_perubahan;
                 app.akte_notaris.no_perubahan=resp.data.no_perubahan;
                 app.akte_notaris.notaris_perubahan=resp.data.notaris_perubahan;
                 app.akte_notaris.alamat_perubahan=resp.data.alamat_perubahan;
                 app.akte_notaris.provinsi_perubahan=resp.data.provinsi_perubahan;
                 app.akte_notaris.kota_perubahan=resp.data.kota_perubahan;
                 app.akte_notaris.tgl_menkum_perubahan=resp.data.tgl_menkum_perubahan;
                 app.akte_notaris.no_menkum_perubahan=resp.data.no_menkum_perubahan;
                 app.akte_notaris.tgl_perubahan_pengadilan=resp.data.tgl_perubahan_pengadilan;
                 app.akte_notaris.no_perubahan_pengadilan=resp.data.no_perubahan_pengadilan;
                 app.akte_notaris.tgl_perubahan_negara=resp.data.tgl_perubahan_negara;
                 app.akte_notaris.no_perubahan_negara=resp.data.no_perubahan_negara;
                 app.akte_notaris.id_akte_notaris=resp.data.id_akte_notaris;
                app.get_kabupaten(resp.data.provinsi_pendirian).then(function(res){
                    app.list_kabupaten_pendirian = res;
                });
                app.get_kabupaten(resp.data.provinsi_perubahan).then(function(re){
                    app.list_kabupaten_perubahan = re;
                });
