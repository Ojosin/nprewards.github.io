                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name='kode_bl' id="kode_bl" type="text"  ref="kode_bl"  v-model="kualifikasi_bl.kode_bl" :class="{'is-invalid':errors.kode_bl}" class="form-control ml-1">
...
export default {
    ...
    methods:{
        ...
        update_data(e){
            ...
            var app = this;
            app.InActive = true;
            $axios.put('/kualifikasi_bl/'+app.kualifikasi_bl.id_kualifikasi_bl,app.kualifikasi_bl).then(function(resp){
        ...
        edit_kualifikasi_bl(){
            ...
            $axios.get('kualifikasi_bl/'+id+'/edit')
            .then(function(resp){
                app.kualifikasi_bl.id_kualifikasi_bl=resp.data.id_kualifikasi_bl;
                app.kualifikasi_bl.kode_bl=resp.data.kode_bl;
                app.kualifikasi_bl.kual=resp.data.kual;
                app.kualifikasi_bl.tgl_aplikasi=resp.data.tgl_aplikasi;
                app.kualifikasi_bl.tgl_pemutus=resp.data.tgl_pemutus;
                app.kualifikasi_bl.tgl_terbit=resp.data.tgl_terbit;
                app.kualifikasi_bl.tgl_berlaku=resp.data.tgl_berlaku;
                app.kualifikasi_bl.no_seri_sbu=resp.data.no_seri_sbu;
                app.kualifikasi_bl.tgl_pengirim=resp.data.tgl_pengirim;
                app.kualifikasi_bl.no_leges=resp.data.no_leges;
                app.kualifikasi_bl.tgl_leges=resp.data.tgl_leges;
            })
