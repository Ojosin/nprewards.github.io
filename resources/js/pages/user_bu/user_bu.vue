        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Data User Badan Usaha
                        <div class="page-title-subheading">Dibawah ini adalah data user badan usaha system SBU INKINDO.
                        </div>
                    </div>
                </div>
                <div class="page-title-actions">
                    <div class="d-inline-block dropdown">
                        <router-link class="btn-shadow btn btn-success" :to="{name:'user-bu.create'}"><i class="fa fa-plus fa-w-20"></i>
                            User Badan Usaha
                        </router-link>
                    </div>
                        ...
                        <table class="mb-0 table">
                            ...
                            <tbody>
                                <tr v-for="row,index in data_show">
                                    ...
                                    <td v-if="row.active == 'active' " align="center">
                                        <a href="javascript:void(0)" class="label-custome label-success fas fa-check text-success"></a>
                                    </td>
                                    ...
                                    <td>
                                        <router-link class="label-custome label-warning" :to="{name:'user-bu.edit',params:{id:row.id}}" ><i class="fa fa-edit"></i>
                                        </router-link>
