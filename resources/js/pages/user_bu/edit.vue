        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Edit User Badan Usaha
                        <div class="page-title-subheading">Form dibawah ini adalah untuk edit user badan usaha pengguna system SBU INKINDO.
                        </div>
                    </div>
                </div>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label for="exampleEmail11" class="ml-1 bintang">No KTA<span style="color:red">*</span></label>
                                        <input name='no_kta' id="no_kta" type="text"  v-model="user.no_kta"  :class="{'is-invalid':errors.no_kta}" class="form-control ml-1" >
